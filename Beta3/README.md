...
E.X.P.L.O.R.: A New World (c) 2002 Beem Media. All rights reserved.

The final beta release of EXPLOR.

## Building
A solution is provided to build the game and associated editor using Visual
Studio 2022.

## History
Originated: March 12, 2002

This was my first DirectX application. You can see from the original readme that
I basically made it over a three day period and then never worked on EXPLOR
again (except to fix one minor bug) until I restarted the project in 2015.
...
### Original README.md (When first posted on GitHub)
<pre>
E.X.P.L.O.R. 2002
=================
